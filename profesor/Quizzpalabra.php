      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="container-fluid align-content-center">
			  <h2 class="breadcrumb justify-content-center text-dark"><b>Quizz de Pronunciación de la
			   <?php 
			   ...
			   <div class="alert alert-success">
				   ...
				   <i class="fas fa-info-circle"></i> Es obligatorio insertar el símbolo fonético.
			  </div>  
		</div>
		  ...
		  <div class="container">
		   <div class="row">
			...
			<div class="form-group  jumbotron">
			  <form action="Quizzpalabra.php" method="post" enctype="multipart/form-data">
				...
				<div class="form-row">
					...
					<div class="col">
      					<input type="text" class="form-control" name="simb" placeholder="Inserta el Símbolo Fonético (Obligatorio)" required>
    				</div>
		...
		<?php
		 ...
		 if($introd<=$numpreg){
			  if(move_uploaded_file($_FILES['imagen']['tmp_name'],$file_upload)){
				  $Qr="insert into quizzgsimb(IdCurso, NumLec, Imagen, Pregunta, Respuesta, Simbolo) VALUES('$idcurso', '$unidad', '$file_upload', '$Pregunta', '$RespC', '$simb')";
				  $ct=mysqli_query($conexion, $Qr);
			  }
			 else{
				 $Qr="insert into quizzsimb(IdCurso, NumLec, Pregunta, Respuesta, Simbolo) VALUES('$idcurso', '$unidad', '$Pregunta', '$RespC','$simb')";
				  if(!empty($Pregunta)){					
					 $ct=mysqli_query($conexion, $Qr);
				 }
			 }
			  ...
			  if(move_uploaded_file($_FILES['imagen']['tmp_name'],$file_upload)){
				  $Qr="insert into quizzsimb(IdCurso, NumLec, Imagen, Pregunta, Respuesta, Simbolo) VALUES('$idcurso', '$unidad', '$file_upload', '$Pregunta', '$RespC', '$simb')";
				  $ct=mysqli_query($conexion, $Qr);
			  }
			 else{
				 $Qr="insert into quizzsimb(IdCurso, NumLec, Pregunta, Respuesta, Simbolo) VALUES('$idcurso', '$unidad', '$Pregunta', '$RespC','$simb')";
