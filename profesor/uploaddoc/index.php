...
<head>
    ...
    <script>
        $(document).ready(function () {
            uploadHBR.init({
                "target": "#uploads",
				"mimes": ["application/msword", "application/pdf", "text/plain"],
 				"max": 6,
                "textNew": "Añadir",
                "textTitle": "Haga clic aquí o arrastre para subir documento",
                "textTitleRemove": "Haga clic aquí quitar documento"
            });
                    ...
                    <div class="row">
                        <div class="col-xs-12 col-md-12">
                            <div class="col-md-12 col-lg-12 col-xs-12" id="columns">
                                <h3 class="form-label">Selecciona documento</h3>
