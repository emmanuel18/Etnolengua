      ...
      <div id="content-wrapper">
        ...
        <div class="container-fluid">
          ...
          <div class="container-fluid align-content-center">
			  <h2 class="breadcrumb justify-content-center text-dark"><b>Quizz de Gramática de la
			   <?php 
			   ...
			   <div class="alert alert-success">
				   ...
				   <i class="fas fa-info-circle"></i> Puedes agregar imágenes para ilustrar mejor la pregunta.
			  </div>  
		</div>
